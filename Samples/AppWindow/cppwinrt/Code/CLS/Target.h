...
#define ESL_INSTA_TYPE_TEMPLATE 9
#define ESL_INSTA_TYPE_OPER 10
...
//Test//first finish simplifying the var easy defs
//Test//work on opposite 'take'Measure Side
//Test//finish takeMeasurement the text with possible special characters and numbers
//save complete publish the classes and get compiler working properly
...
namespace ecoin
{
	...
	extern void ag_EcoinSecure_Inf_Loop_Assert(int f_A, int f_B);

	extern void ag_EcoinSecure_Inf_Loop_Assert_EQ(int f_A, int f_B);
	...
	public:
		...
		shared_ptr<Qcom_eslfunction> acConvert(shared_ptr<Qcom> f_Com);
	...
	public:
		LMap()
			...
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&LMap::acClear);
#endif
