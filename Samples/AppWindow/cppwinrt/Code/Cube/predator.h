...
class predatorIDX : public ecom_base
{
	predatorIDX()
		...
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&predatorIDX::acClear);
#endif
		}
...
public:
	predatorAction()
		...
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&predatorAction::acClear);
#endif
		};
...
public:
	predatorPanelText()
		...
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&predatorPanelText::acClear);
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acSave", (ecom_base::ControllerMethod_void)&predatorPanelText::acSave);
#endif
		};
...
#ifdef ECOIN_OSI_MEMORY
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acSave", (ecom_base::ControllerMethod_void)&predatorInstanceManager::acSave);
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acSaveAll", (ecom_base::ControllerMethod_void)&predatorInstanceManager::acSaveAll);
#endif
		};
