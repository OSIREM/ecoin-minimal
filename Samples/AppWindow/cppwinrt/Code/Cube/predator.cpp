...
predatorInstance::predatorInstance()
{
	...
	ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "ac_Clear", (ecom_base::ControllerMethod_void)&predatorInstance::ac_Clear);
	ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acSave", (ecom_base::ControllerMethod_void)&predatorInstance::acSave);
	ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acSaveAll", (ecom_base::ControllerMethod_void)&predatorInstance::acSaveAll);
#endif
}
