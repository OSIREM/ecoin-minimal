...
uint g_ElementCount = 0;
double g_HeshPerSecond = 0;
...
bool ag_VerifyTXIN(std::shared_ptr<CubeTXIN> f_txin, float f_amount)
{
	...
	std::shared_ptr<CubeTransaction> f_PrevTX = ag_get_TXfromvout(f_txin->m_vout);
...
std::shared_ptr<ShareContainerExt> ag_SelectPeerGraphExt(int f_JobID, int f_ServLay, int f_ShareID, int f_ShareOffset, int f_PEER, bool f_MainMutex)
{
	...
	if(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_ShareCNT = g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->size();
		}

	if(f_ShareCNT > 0)
		{
		f_ShareContainer->m_espo_Owner = g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[0];
		f_ShareContainer->m_espo_Date = g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[1];
		f_ShareContainer->m_espo_ShareOffset = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[2].c_str());
		f_ShareContainer->m_espo_Peer = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[3].c_str());
		f_ShareContainer->m_espo_ID = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[4].c_str());
		f_ShareContainer->m_espo_Score = atof(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[5].c_str());
		f_ShareContainer->m_espo_Amount = atof(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[6].c_str());
		f_ShareContainer->m_espo_ECN_Amount = atof(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[7].c_str());
		f_ShareContainer->m_espo_ScoreSum = atof(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[8].c_str());
		f_ShareContainer->m_espo_PeerCount = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[9].c_str());
		f_ShareContainer->m_espo_SharesOnPeerCount = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[10].c_str());
		f_ShareContainer->m_espo_TotalShares = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[11].c_str());
		f_ShareContainer->m_espo_TotalSharesOwnPeer = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[12].c_str());
		f_ShareContainer->m_espo_OwnPeerIndex = atoi(g_Schedular[f_ServLay]->m_Entries[g_Schedular[f_ServLay]->ac_GetEntry(g_Schedular[f_ServLay]->m_Entries.size() - 1)]->at(0)[13].c_str());
		}
...
void ag_Upload_Procedures(bool f_ResetProc)
{
	 /////////////////////////////////////////////////
...
float ag_CalcOwnerGenesisTX(std::string f_Owner, int f_ShareID, std::shared_ptr<Cube::CubeTransaction> f_TX)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_AmtLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
		}

	//ECN::Stat::: f_TxLCount f_TxLCount
	if(f_AmtLCount == 1)
		{
		f_Amount = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1].c_str());
		}
	else
		{
...
std::shared_ptr<CubeTransaction> ag_getTX(int f_txid, int f_txoutid) //f_txoutid: optional, sets flag upon found for use later
{
	...
	if(f_TxLCount > 0)
		{
		f_TX->m_txid = f_txid;
		f_TX->m_status = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].c_str());
		f_TX->m_type = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1].c_str());
		f_TX->m_Hash = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[2];
		f_TX->m_confirmation = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[5].c_str());
		f_TX->m_amt = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[3].c_str());
		f_TX->m_fee = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[4].c_str());
		f_TX->m_jobid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[6].c_str());
		f_TX->m_reward = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[7].c_str());
		f_TX->m_rewardid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[8].c_str());
		f_TX->m_blocktype = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[9].c_str());
		f_TX->m_hdid = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[10];
		int f_gnsharesupport = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[11].c_str());
		f_TX->m_owner = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[12];
		f_TX->m_Hashnib = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[13];
		f_TX->m_blockid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[14].c_str());
		...
		if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
			...
			{
			f_TxoutLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
			}
		...
		if(f_TxoutLCount > 0)
			...
			for(int f_jet = 0; f_jet < f_TxoutLCount; f_jet++)
				...
				f_txout->m_txoutid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_jet)[0].c_str());
				f_txout->m_adrid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_jet)[1].c_str());
				f_txout->m_owner = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_jet)[2];
				f_txout->m_txoutamt = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_jet)[3].c_str());
				f_txout->m_owneramt = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_jet)[4].c_str());
				f_txout->m_myelementcount = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_jet)[5].c_str());
		...
		if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
			...
			{
			f_TxinLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
			}
		...
		if(f_TxinLCount > 0)
			...
			for(int f_jet = 0; f_jet < f_TxinLCount; f_jet++)
				...
				f_txin->m_txinid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].c_str());
				f_txin->m_vout = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1];
				f_txin->m_pubkey = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[2];
				f_txin->m_sigstr = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[3];
				float f_txinrow4 = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[4].c_str());

				  ///////////////////
				 // TXIN vout
				std::string f_vout = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1];
				...
				if(f_vout.compare("Genesis Tracking") == 0)
					...
					if(f_TxoutLCount == 1)
						...
						if(f_AdrCount > 0)
							...
							float f_peer_Amount = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1].c_str());
					...
					h_OK = ag_Verify_PublicSigniture(f_PubKeyB, f_HashB, f_SignitureB);
...
std::shared_ptr<CubeTransaction> ag_getTX(int f_ShareID, float f_CostCPS)
{
	...
	if(f_TxLCount > 0)
		{
		f_TX->m_txid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].c_str());
		f_TX->m_status = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1].c_str());
		f_TX->m_type = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[2].c_str());
		f_TX->m_Hash = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[3];
		f_TX->m_confirmation = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[6].c_str());
		f_TX->m_amt = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[4].c_str());
		f_TX->m_fee = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[5].c_str());
		f_TX->m_jobid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[7].c_str());
		f_TX->m_reward = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[8].c_str());
		f_TX->m_rewardid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[9].c_str());
		f_TX->m_blocktype = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[10].c_str());
		f_TX->m_hdid = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[11];
		f_TX->m_shareid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[12].c_str());
		int f_gnsharesupport = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[13].c_str());
		f_TX->m_owner = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[14];
		f_TX->m_blockid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[15].c_str());
...
std::shared_ptr<CubeTransaction> ag_get_TXfromvout(std::string f_vout)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) != '0')
		{
		int f_TXoutID = ag_CheckInteger(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1]);
		int f_TxLID = ag_CheckInteger(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0]);

		if((f_TxLID > 0) && (f_TXoutID > 0))
			{
			f_TX = ag_getTX(f_TxLID, f_TXoutID);
...
bool ag_Verify_TX_ReHash_VerifySigniture(std::shared_ptr<Cube::CubeTransaction> f_TX)
{
	...
	bool h_OK = ag_Verify_PublicSigniture(f_PubKey, f_Hash, f_Signiture);
...
float ag_OwnerBalance(std::string f_owner)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_balCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
		}
...
std::shared_ptr<Cube::CubeResults> ag_GatherTransactions(int f_JobID, int f_IDX)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_TxCLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
		}
	...
	if(f_TxCLCount == 1)
		{
		f_TXRowCount = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].c_str());
		...
		std::shared_ptr<std::vector<std::vector<std::string>>> f_EntryTX = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)];
		...
		if(f_TxLCount > 0)
			...
			if(f_TxNibLCount == 1)
				{
				f_CurrentNib = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[1];
				}
						...
						if(f_vec_TX[f_RM]->m_status != -5)
							...
							if(((f_txlc == 2) && (f_RMlc == 2)) && (f_txowner.compare(f_RMowner) == 0) && (f_txjobid == f_RMjobid))
								...
								if(f_txid > f_RMid)
									...
									std::shared_ptr<CubeTransaction> f_TransactionA = ag_getTX(f_RMid);

									f_TransactionA->m_fresh = VERIFY_FAIL;

									f_unverified_Result += ag_cont_VerifySingleTransaction(f_TransactionA, VERIFY_FAIL);
									}
								}
							}
						}
			...
			for(int f_t = 0; f_t < f_idx_vec_TX; f_t++)
				...
				if(f_vec_TX[f_t]->m_status != -5)
					...
					if(f_vec_TX[f_t]->m_confirmation < 6)
						{
						std::shared_ptr<CubeTransaction> f_TransactionA = ag_getTX(f_vec_TX[f_t]->m_txid);
						...
						if(f_TransactionA->isValid() == true)
							...
							f_Result += ag_cont_VerifySingleTransaction(f_TransactionA, VERIFY_FAIL);
			...
			if(f_ResultOn == true)
				...
				if(f_lastTransactionA != nullptr)
					{
					f_ReferencesPad = ag_GatherAllReferences(f_lastTransactionA->m_jobid, f_IDX);
...
std::string ag_GatherAllReferences(int f_JobID, int f_IDX)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_RfLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
		}

	if(f_RfLCount == 1)
		{
		f_ReferencePad = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0];
				...
				if((f_Transaction->m_txin[f_Jet]->m_gnshareid > 0) || (f_Transaction->m_txin[f_Jet]->m_vout.compare("Genesis Coin") == 0) || (f_Transaction->m_txin[f_Jet]->m_vout.compare("Genesis Tracking") == 0))
					...
					if((f_Transaction->m_txin[f_Jet]->m_vout.compare("Genesis Tracking") == 0))
						...
						if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
							...
							{
							f_RewardLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
							}
						...
						if(f_RewardLCount != 1)
							...
							{
							float f_Reward = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].c_str());
...
void Cube::CubeTransaction::acSynchronize(void)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_SyncLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
		}
...
int ag_GenerateTransaction(std::string f_A, std::string f_B, float f_amt, std::shared_ptr<CubeTransaction> f_tx)
	{
...
bool ag_addGenesisTracking(int f_gnid, int f_blocktype, int f_elementcount)
{
	...
	if(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].at(0) == '0')
		...
		{
		f_hdLCount = g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->size();
		}
	...
	if(f_hdLCount == 0)
		...
		int f_txoutID = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(0)[0].c_str());
...
CubeBicycle::CubeBicycle(FILE* f_File)
	...
	for(int f_I = 0; f_I < f_VertSize; f_I++)
		{
		std::shared_ptr<Cube::BiVector> f_Vector = std::make_shared<Cube::BiVector>(acBufreadValueFloat(f_File), acBufreadValueFloat(f_File), acBufreadValueFloat(f_File));
	...
	for(int f_C = 0; f_C < f_ColorSize; f_C++)
		{
		std::shared_ptr<Cube::BiVector> f_Color = std::make_shared<Cube::BiVector>(acBufreadValueFloat(f_File), acBufreadValueFloat(f_File), acBufreadValueFloat(f_File));
...
CubeBicycle::CubeBicycle(std::string f_Buffer)
	...
	for(int f_I = 0; f_I < f_VertSize; f_I++)
		{
		std::shared_ptr<Cube::BiVector> f_Vector = std::make_shared<Cube::BiVector>(acBufreadValueFloat((char *)f_Buffer.c_str()), acBufreadValueFloat((char *)f_Buffer.c_str()), acBufreadValueFloat((char *)f_Buffer.c_str()));
	...
	for(int f_C = 0; f_C < f_ColorSize; f_C++)
		{
		std::shared_ptr<Cube::BiVector> f_Color = std::make_shared<Cube::BiVector>(acBufreadValueFloat((char *)f_Buffer.c_str()), acBufreadValueFloat((char *)f_Buffer.c_str()), acBufreadValueFloat((char *)f_Buffer.c_str()));
