...
public:
	...
	void acSelect(bool f_Selection);
	void acSelect_pach(void); //shadow void

	void acHighLight(bool f_Selection);
	void acHighLight_pach(void); //shadow void
...
public:
	QcomWire()
		...
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "ac_Save", (ecom_base::ControllerMethod_void)&QcomWire::ac_Save);
#endif
		};
...
public:
	BiPacket()
		...
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&BiPacket::acClear);
#endif
		}
...
public:
	SelectionPreList()
		...
		ag_StatusLive(f_ref_CurrentPath, "m_position");
		m_position = std::make_shared_reflect<BiVector>(0.0f);
...
class BiDecisionA : public ecom_base
	...
	public:
		BiDecisionA(std::string f_TitleText, std::string f_ObjectNameOverride, int f_Trial_Length = -1, int f_Trial_QamID = 0)
			...
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acApply", (ecom_base::ControllerMethod_void)&BiDecisionA::acApply);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acUnApply", (ecom_base::ControllerMethod_void)&BiDecisionA::acUnApply);
#endif
			};
...
class BiDecisionOverride : public ecom_base
	...
	public:
		BiDecisionOverride()
			...
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acScan", (ecom_base::ControllerMethod_void)&BiDecisionOverride::acScan);
#endif
			};
...
class BiDecisionQ : public ecom_base
	...
	public:
		BiDecisionQ(int f_PipeChan = 0, int f_ComID = -1, int f_ShareID = -1)
			...
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acSelectOverrides", (ecom_base::ControllerMethod_void)&BiDecisionQ::acSelectOverrides);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&BiDecisionQ::acClear);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acStoreCount", (ecom_base::ControllerMethod_void)&BiDecisionQ::acStoreCount);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acCheck_Show", (ecom_base::ControllerMethod_void)&BiDecisionQ::acCheck_Show);
#endif
...
class DecisionWheel : public ecom_base
	...
	public:
		DecisionWheel()
			...
			m_SelectPosition = std::make_shared_reflect<Cube::BiVector>(0.0f);
			...
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acPressOut", (ecom_base::ControllerMethod_void)&DecisionWheel::acPressOut);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acPressIn", (ecom_base::ControllerMethod_void)&DecisionWheel::acPressIn);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClearHighLight", (ecom_base::ControllerMethod_void)&DecisionWheel::acClearHighLight);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&DecisionWheel::acClear);
#endif
			}
		~DecisionWheel()
			{
...
#ifdef ECOIN_OSI_MEMORY
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acFrame", (ecom_base::ControllerMethod_void)&DecisionManager::acFrame);
			ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acLoad_ApplicationSpecificLegacy", (ecom_base::ControllerMethod_void)&DecisionManager::acLoad_ApplicationSpecificLegacy);
#endif
...
public:
	BiCheckpointDescriptor(std::string f_FunctionLocation, std::string f_PositioninFunction)
		...
		ac_PushFunction(f_ref_CurrentPath + g_ref_fun_Div + "acClear", (ecom_base::ControllerMethod_void)&DecisionManager::acClear);
#endif
...
typedef bool (QcomManager::* QcomMngrFn_bool_void)(void) const;
typedef void (QcomManager::* QcomMngrFn_void_void)(void) const;
typedef void (QcomManager::* QcomMngrFn_void_qcom)(std::shared_ptr<Qcom>) const;
typedef void (QcomManager::* QcomMngrFn_void_int_int)(int, int) const;

void (QcomManager::* qcom_ControllerMethod)() = &QcomManager::acClear;
