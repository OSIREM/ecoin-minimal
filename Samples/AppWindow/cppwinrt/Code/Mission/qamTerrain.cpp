...
qamTerrain::qamTerrain(int f_ID) : qamType(qamTYPE_Terrain)
{
	...
	if(f_Int)
		...
		if(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->size())
			{
			m_X = atof(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[1].c_str());
			m_Y = atof(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[2].c_str());
			m_Z = atof(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[3].c_str());

			m_Xrot = atof(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[4].c_str());
			m_Yrot = atof(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[5].c_str());
			m_Zrot = atof(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[6].c_str());

			m_TerrainInsertFillX = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[7].c_str());
			m_TerrainInsertFillY = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[8].c_str());
			m_TerrainInsertFillZ = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[9].c_str());
			m_TerrainInsertMoveX = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[10].c_str());
			m_TerrainInsertMoveY = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[11].c_str());
			m_TerrainInsertMoveZ = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[12].c_str());
			m_TerrainInsertNegatedX = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[13].c_str());
			m_TerrainInsertNegatedY = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[14].c_str());
			m_TerrainInsertNegatedZ = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[15].c_str());
			m_TerrainInsertMaxX = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[16].c_str());
			m_TerrainInsertMaxY = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[17].c_str());
			m_TerrainInsertMaxZ = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[18].c_str());
			
			m_materialid = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[19].c_str());
			m_DefaultShape = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[20].c_str());
			m_Order = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[21].c_str());
			m_Type = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[22].c_str());
			m_Repeat = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[23].c_str());

			m_QamLevel = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[24].c_str());
			m_QamID = atoi(g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[25].c_str());
			m_NameGroup = g_Schedular[2]->m_Entries[g_Schedular[2]->ac_GetEntry(g_Schedular[2]->m_Entries.size() - 1)]->at(0)[26];
			}
						...
						for(int f_fillY = 1; f_fillY < (m_TerrainInsertFillY + 1); f_fillY++)
							...
							for(int f_fillZ = 1; f_fillZ < (m_TerrainInsertFillZ + 1); f_fillZ++)
								...
								if((((m_TerrainInsertNegatedX > 0) && (f_fillX > m_TerrainInsertNegatedX)) || ((m_TerrainInsertNegatedX < 0) && (f_fillX < m_TerrainInsertFillX - (m_TerrainInsertNegatedX * -1)) || (m_TerrainInsertNegatedX == 0))) &&
								 ...
								 // fpos
								//
								f_Pos.m_X = m_X + (((f_fillX * (VoxelGrid::BLOCK_RENDER_SIZE * 2.0f)) * f_moveX));
								f_Pos.m_Y = m_Y + (((f_fillY * (VoxelGrid::BLOCK_RENDER_SIZE * 2.0f)) * f_moveY));
								f_Pos.m_Z = m_Z + (((f_fillZ * (VoxelGrid::BLOCK_RENDER_SIZE * 2.0f)) * f_moveZ));
											...
											for(int z = 0; z < VoxelGrid::VOXEL_GRID_SIZE; z++)
												...
												if(f_ForceFac <= 15.5f)
													...
													if(!f_Grid->m_rebuild)
														...
														f_Grid = new VoxelGrid(f_ManagerIndex);
