...
{
	std::shared_ptr<predatorPanelText> f_Panel = std::make_shared<predatorPanelText>(f_function);
...
std::shared_ptr<predatorInstance> predatorInstanceManager::acSearchIns_byComID(std::shared_ptr<Qcom> f_com)
{
	...
	std::shared_ptr<predatorInstance> f_Ins = std::make_shared<predatorInstance>(f_com);
