...
std::future<void> Sample3DSceneRenderer::CreateDeviceDependentResources(void)
{
	...
	for(int f_XY = 0; f_XY < Cube::g_BicycleContainer[0]->m_ADMAX; f_XY++)
		...
		std::shared_ptr<Cube::BiVector> f_Vector1 = std::make_shared_reflect<Cube::BiVector>(-0.5f);
		f_Vector1->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector2");
		std::shared_ptr<Cube::BiVector> f_Vector2 = std::make_shared_reflect<Cube::BiVector>(-0.5f, -0.5f, 0.5f);
		f_Vector2->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector3");
		std::shared_ptr<Cube::BiVector> f_Vector3 = std::make_shared_reflect<Cube::BiVector>(-0.5f, 0.5f, -0.5f);
		f_Vector3->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector4");
		std::shared_ptr<Cube::BiVector> f_Vector4 = std::make_shared_reflect<Cube::BiVector>(-0.5f, 0.5f, 0.5f);
		f_Vector4->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector5");
		std::shared_ptr<Cube::BiVector> f_Vector5 = std::make_shared_reflect<Cube::BiVector>(0.5f, -0.5f, -0.5f);
		f_Vector5->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector6");
		std::shared_ptr<Cube::BiVector> f_Vector6 = std::make_shared_reflect<Cube::BiVector>(0.5f, -0.5f, 0.5f);
		f_Vector6->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector7");
		std::shared_ptr<Cube::BiVector> f_Vector7 = std::make_shared_reflect<Cube::BiVector>(0.5f, 0.5f, -0.5f);
		f_Vector7->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
		f_BiRand.acGet();
		ag_StatusLive(f_ref_CurrentPath, "f_Vector8");
		std::shared_ptr<Cube::BiVector> f_Vector8 = std::make_shared_reflect<Cube::BiVector>(0.5f, 0.5f, 0.5f);
		f_Vector8->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);

		ag_StatusLive(f_ref_CurrentPath, "f_Color1");
		std::shared_ptr<Cube::BiVector> f_Color1 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color2");
		std::shared_ptr<Cube::BiVector> f_Color2 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color3");
		std::shared_ptr<Cube::BiVector> f_Color3 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color4");
		std::shared_ptr<Cube::BiVector> f_Color4 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color5");
		std::shared_ptr<Cube::BiVector> f_Color5 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color6");
		std::shared_ptr<Cube::BiVector> f_Color6 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color7");
		std::shared_ptr<Cube::BiVector> f_Color7 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
		ag_StatusLive(f_ref_CurrentPath, "f_Color8");
		std::shared_ptr<Cube::BiVector> f_Color8 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
...
void Sample3DSceneRenderer::acSaveCompletePublish_GenHesh_Upper_Reflection(void)
{
	...
	while(f_Bike_Low > f_Hesh_Cade->vec_Bicycle.size())
		...
		// Load mesh vertices. Each vertex has a position and a color.
		ag_StatusLive(f_ref_CurrentPath, "f_Vector1_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector1 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[0]->m_X, f_WonBike->vec_Vertex[0]->m_Y, f_WonBike->vec_Vertex[0]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector2_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector2 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[1]->m_X, f_WonBike->vec_Vertex[1]->m_Y, f_WonBike->vec_Vertex[1]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector3_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector3 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[2]->m_X, f_WonBike->vec_Vertex[2]->m_Y, f_WonBike->vec_Vertex[2]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector4_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector4 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[3]->m_X, f_WonBike->vec_Vertex[3]->m_Y, f_WonBike->vec_Vertex[3]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector5_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector5 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[4]->m_X, f_WonBike->vec_Vertex[4]->m_Y, f_WonBike->vec_Vertex[4]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector6_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector6 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[5]->m_X, f_WonBike->vec_Vertex[5]->m_Y, f_WonBike->vec_Vertex[5]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector7_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector7 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[6]->m_X, f_WonBike->vec_Vertex[6]->m_Y, f_WonBike->vec_Vertex[6]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Vector8_Joining");
		std::shared_ptr<Cube::BiVector> f_Vector8 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[7]->m_X, f_WonBike->vec_Vertex[7]->m_Y, f_WonBike->vec_Vertex[7]->m_Z);

		ag_StatusLive(f_ref_CurrentPath, "f_Color1_Joining");
		std::shared_ptr<Cube::BiVector> f_Color1 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[0]->m_X, f_WonBike->vec_Color[0]->m_Y, f_WonBike->vec_Color[0]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color2_Joining");
		std::shared_ptr<Cube::BiVector> f_Color2 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[1]->m_X, f_WonBike->vec_Color[1]->m_Y, f_WonBike->vec_Color[1]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color3_Joining");
		std::shared_ptr<Cube::BiVector> f_Color3 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[2]->m_X, f_WonBike->vec_Color[2]->m_Y, f_WonBike->vec_Color[2]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color4_Joining");
		std::shared_ptr<Cube::BiVector> f_Color4 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[3]->m_X, f_WonBike->vec_Color[3]->m_Y, f_WonBike->vec_Color[3]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color5_Joining");
		std::shared_ptr<Cube::BiVector> f_Color5 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[4]->m_X, f_WonBike->vec_Color[4]->m_Y, f_WonBike->vec_Color[4]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color6_Joining");
		std::shared_ptr<Cube::BiVector> f_Color6 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[5]->m_X, f_WonBike->vec_Color[5]->m_Y, f_WonBike->vec_Color[5]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color7_Joining");
		std::shared_ptr<Cube::BiVector> f_Color7 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[6]->m_X, f_WonBike->vec_Color[6]->m_Y, f_WonBike->vec_Color[6]->m_Z);
		ag_StatusLive(f_ref_CurrentPath, "f_Color8_Joining");
		std::shared_ptr<Cube::BiVector> f_Color8 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[7]->m_X, f_WonBike->vec_Color[7]->m_Y, f_WonBike->vec_Color[7]->m_Z);
	...
	while(g_Compressing == 1)
		...
		if(f_Collection->m_vec_Element.size() > 0)
			{
			f_SizeMin = f_Collection->m_vec_Element.size() - 1;

			for(int f_XYZ = f_SizeMin; f_XYZ >= 0; f_XYZ--)
				{
		...
		//######--
		int f_SoLowtonBicycleSize = g_Lowton->vec_Bicycle.size() - 1;
			...
			if((g_LowtonOn == true) && ((g_classLMap->m_CPS_Result[f_OCSCP_ThreadIndex] == CPS_SCAN) && (g_Result == false)))
				...
				while(f_SizeMin < f_SoLowtonBicycleSize)
					...
					if(f_SizeMin >= f_Hesh_Cade->vec_Bicycle.size())
						...
						// Load mesh vertices. Each vertex has a position and a color.
						ag_StatusLive(f_ref_CurrentPath, "f_Vector1_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector1 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[0]->m_X, f_WonBike->vec_Vertex[0]->m_Y, f_WonBike->vec_Vertex[0]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector2_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector2 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[1]->m_X, f_WonBike->vec_Vertex[1]->m_Y, f_WonBike->vec_Vertex[1]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector3_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector3 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[2]->m_X, f_WonBike->vec_Vertex[2]->m_Y, f_WonBike->vec_Vertex[2]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector4_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector4 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[3]->m_X, f_WonBike->vec_Vertex[3]->m_Y, f_WonBike->vec_Vertex[3]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector5_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector5 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[4]->m_X, f_WonBike->vec_Vertex[4]->m_Y, f_WonBike->vec_Vertex[4]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector6_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector6 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[5]->m_X, f_WonBike->vec_Vertex[5]->m_Y, f_WonBike->vec_Vertex[5]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector7_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector7 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[6]->m_X, f_WonBike->vec_Vertex[6]->m_Y, f_WonBike->vec_Vertex[6]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Vector8_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Vector8 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Vertex[7]->m_X, f_WonBike->vec_Vertex[7]->m_Y, f_WonBike->vec_Vertex[7]->m_Z);

						ag_StatusLive(f_ref_CurrentPath, "f_Color1_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color1 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[0]->m_X, f_WonBike->vec_Color[0]->m_Y, f_WonBike->vec_Color[0]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color2_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color2 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[1]->m_X, f_WonBike->vec_Color[1]->m_Y, f_WonBike->vec_Color[1]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color3_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color3 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[2]->m_X, f_WonBike->vec_Color[2]->m_Y, f_WonBike->vec_Color[2]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color4_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color4 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[3]->m_X, f_WonBike->vec_Color[3]->m_Y, f_WonBike->vec_Color[3]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color5_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color5 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[4]->m_X, f_WonBike->vec_Color[4]->m_Y, f_WonBike->vec_Color[4]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color6_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color6 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[5]->m_X, f_WonBike->vec_Color[5]->m_Y, f_WonBike->vec_Color[5]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color7_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color7 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[6]->m_X, f_WonBike->vec_Color[6]->m_Y, f_WonBike->vec_Color[6]->m_Z);
						ag_StatusLive(f_ref_CurrentPath, "f_Color8_LowtonUp");
						std::shared_ptr<Cube::BiVector> f_Color8 = std::make_shared_reflect<Cube::BiVector>(f_WonBike->vec_Color[7]->m_X, f_WonBike->vec_Color[7]->m_Y, f_WonBike->vec_Color[7]->m_Z);
		...
		if(f_ElementOnce > 0)
			...
			for(int f_Int = f_SizeMin; f_Int < f_PossibleTarget; f_Int++)
				...
				if(f_Int >= f_Hesh_Cade->vec_Bicycle.size())
					...
					// Load mesh vertices. Each vertex has a position and a color.
					Cube::BiRand f_BiRand;
					ag_StatusLive(f_ref_CurrentPath, "f_Vector1_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector1 = std::make_shared_reflect<Cube::BiVector>(-0.5f + SCP_ADD_ON);
					f_Vector1->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector2_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector2 = std::make_shared_reflect<Cube::BiVector>(-0.5f + SCP_ADD_ON, -0.5f + SCP_ADD_ON, 0.5f + SCP_ADD_ON);
					f_Vector2->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector3_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector3 = std::make_shared_reflect<Cube::BiVector>(-0.5f + SCP_ADD_ON, 0.5f + SCP_ADD_ON, -0.5f + SCP_ADD_ON);
					f_Vector3->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector4_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector4 = std::make_shared_reflect<Cube::BiVector>(-0.5f + SCP_ADD_ON, 0.5f + SCP_ADD_ON, 0.5f + SCP_ADD_ON);
					f_Vector4->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector5_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector5 = std::make_shared_reflect<Cube::BiVector>(0.5f + SCP_ADD_ON, -0.5f + SCP_ADD_ON, -0.5f + SCP_ADD_ON);
					f_Vector5->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector6_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector6 = std::make_shared_reflect<Cube::BiVector>(0.5f + SCP_ADD_ON, -0.5f + SCP_ADD_ON, 0.5f + SCP_ADD_ON);
					f_Vector6->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector7_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector7 = std::make_shared_reflect<Cube::BiVector>(0.5f + SCP_ADD_ON, 0.5f + SCP_ADD_ON, -0.5f + SCP_ADD_ON);
					f_Vector7->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);
					f_BiRand.acGet();
					ag_StatusLive(f_ref_CurrentPath, "f_Vector8_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Vector8 = std::make_shared_reflect<Cube::BiVector>(0.5f + SCP_ADD_ON);
					f_Vector8->acPushRandSphere(Cube::g_swit, f_BiRand.m_Seed);

					ag_StatusLive(f_ref_CurrentPath, "f_Color1_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color1 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color2_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color2 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color3_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color3 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color4_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color4 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color5_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color5 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color6_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color6 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color7_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color7 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					ag_StatusLive(f_ref_CurrentPath, "f_Color8_ElementOnce");
					std::shared_ptr<Cube::BiVector> f_Color8 = std::make_shared_reflect<Cube::BiVector>(Cube::random(), Cube::random(), Cube::random());
					...
					if(g_Compressing == 1)
						...
						for(int f_Jet = g_Lowton->vec_Bicycle.size(); f_Jet < f_OC_Mark_Count; f_Jet++)
							...
							if(f_Jet < f_Hesh_Cade->vec_Bicycle.size())
								...
								// Load mesh vertices. Each vertex has a position and a color.
								ag_StatusLive(f_ref_CurrentPath, "f_Vector1_Result");
								std::shared_ptr<Cube::BiVector> f_Vector1 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[0]->m_X, f_WinningBike->vec_Vertex[0]->m_Y, f_WinningBike->vec_Vertex[0]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector2_Result");
								std::shared_ptr<Cube::BiVector> f_Vector2 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[1]->m_X, f_WinningBike->vec_Vertex[1]->m_Y, f_WinningBike->vec_Vertex[1]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector3_Result");
								std::shared_ptr<Cube::BiVector> f_Vector3 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[2]->m_X, f_WinningBike->vec_Vertex[2]->m_Y, f_WinningBike->vec_Vertex[2]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector4_Result");
								std::shared_ptr<Cube::BiVector> f_Vector4 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[3]->m_X, f_WinningBike->vec_Vertex[3]->m_Y, f_WinningBike->vec_Vertex[3]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector5_Result");
								std::shared_ptr<Cube::BiVector> f_Vector5 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[4]->m_X, f_WinningBike->vec_Vertex[4]->m_Y, f_WinningBike->vec_Vertex[4]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector6_Result");
								std::shared_ptr<Cube::BiVector> f_Vector6 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[5]->m_X, f_WinningBike->vec_Vertex[5]->m_Y, f_WinningBike->vec_Vertex[5]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector7_Result");
								std::shared_ptr<Cube::BiVector> f_Vector7 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[6]->m_X, f_WinningBike->vec_Vertex[6]->m_Y, f_WinningBike->vec_Vertex[6]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Vector8_Result");
								std::shared_ptr<Cube::BiVector> f_Vector8 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Vertex[7]->m_X, f_WinningBike->vec_Vertex[7]->m_Y, f_WinningBike->vec_Vertex[7]->m_Z);

								ag_StatusLive(f_ref_CurrentPath, "f_Color1_Result");
								std::shared_ptr<Cube::BiVector> f_Color1 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[0]->m_X, f_WinningBike->vec_Color[0]->m_Y, f_WinningBike->vec_Color[0]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color2_Result");
								std::shared_ptr<Cube::BiVector> f_Color2 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[1]->m_X, f_WinningBike->vec_Color[1]->m_Y, f_WinningBike->vec_Color[1]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color3_Result");
								std::shared_ptr<Cube::BiVector> f_Color3 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[2]->m_X, f_WinningBike->vec_Color[2]->m_Y, f_WinningBike->vec_Color[2]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color4_Result");
								std::shared_ptr<Cube::BiVector> f_Color4 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[3]->m_X, f_WinningBike->vec_Color[3]->m_Y, f_WinningBike->vec_Color[3]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color5_Result");
								std::shared_ptr<Cube::BiVector> f_Color5 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[4]->m_X, f_WinningBike->vec_Color[4]->m_Y, f_WinningBike->vec_Color[4]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color_Result6");
								std::shared_ptr<Cube::BiVector> f_Color6 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[5]->m_X, f_WinningBike->vec_Color[5]->m_Y, f_WinningBike->vec_Color[5]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color_Result7");
								std::shared_ptr<Cube::BiVector> f_Color7 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[6]->m_X, f_WinningBike->vec_Color[6]->m_Y, f_WinningBike->vec_Color[6]->m_Z);
								ag_StatusLive(f_ref_CurrentPath, "f_Color8_Result");
								std::shared_ptr<Cube::BiVector> f_Color8 = std::make_shared_reflect<Cube::BiVector>(f_WinningBike->vec_Color[7]->m_X, f_WinningBike->vec_Color[7]->m_Y, f_WinningBike->vec_Color[7]->m_Z);
						...
						ag_addGenesisTracking(f_SCP_ShareID, ecoin_BlockType::ecoin_Block_Target_SCP, f_OC_Lowton_Mark_Count);
						...
						if(f_OC_Lowton_Mark_Count >= g_classLMap->m_ADMAX) //complete work, winning conditions!
							...
							std::shared_ptr<ShareContainerExt> f_PG = ag_SelectPeerGraphExt(g_JobID, 0, f_SCP_ShareID, g_CurrentShareOffset, g_PEER);
	...
	while(g_Viewing == 0)
		...
		if((f_Result == true) && (g_KeepShare == false))
			...
			if(f_ShareLCount == 0)
				...
				ag_addGenesisTracking(f_ShareUniqueID, g_BlockType);
