...
#if 0
std::shared_ptr<BiProtocolExNode> g_MainNode;
std::shared_ptr<BiProtocolExNode> g_ExcomPexMain;
std::shared_ptr<BiProtocolExNode> g_InstallMain;
#endif
...
{
	m_txid = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_Index)[0].c_str());
	m_status = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_Index)[1].c_str());
	m_confirmation = atoi(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_Index)[2].c_str());
	m_amt = atof(g_Schedular[0]->m_Entries[g_Schedular[0]->ac_GetEntry(g_Schedular[0]->m_Entries.size() - 1)]->at(f_Index)[3].c_str());
}
...
namespace winrt::SDKTemplate::implementation
{
		...
		m_FirstAll(true)
	{
		...
		f_StringLine[2] = "Var%%float&&V8X%%0.0&%////";
		f_StringLine[3] = "Var%%float&&V8X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V7X%%////";
		f_StringLine[4] = "Var%%float&&V7X%%0.0&%////";
		f_StringLine[5] = "Var%%float&&V7X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V6X%%////";
		f_StringLine[6] = "Var%%float&&V6X%%0.0&%////";
		f_StringLine[7] = "Var%%float&&V6X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V5X%%////";
		f_StringLine[8] = "Var%%float&&V5X%%0.0&%////";
		f_StringLine[9] = "Var%%float&&V5X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V4X%%////";
		f_StringLine[10] = "Var%%float&&V4X%%0.0&%////";
		f_StringLine[11] = "Var%%float&&V4X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V3X%%////";
		f_StringLine[12] = "Var%%float&&V3X%%0.0&%////";
		f_StringLine[13] = "Var%%float&&V3X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V2X%%////";
		f_StringLine[14] = "Var%%float&&V2X%%0.0&%////";
		f_StringLine[15] = "Var%%float&&V2X%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V1X%%////";
		f_StringLine[16] = "Var%%float&&V1X%%0.0&%////";
		f_StringLine[17] = "Var%%float&&V1X%%0.0&%Opr%%Plus**OPRVX87%%Sys%%float&&Posx%%////";
		f_StringLine[18] = "Var%%float&&V8Y%%0.0&%////";
		f_StringLine[19] = "Var%%float&&V8Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V7Y%%////";
		f_StringLine[20] = "Var%%float&&V7Y%%0.0&%////";
		f_StringLine[21] = "Var%%float&&V7Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V6Y%%////";
		f_StringLine[22] = "Var%%float&&V6Y%%0.0&%////";
		f_StringLine[23] = "Var%%float&&V6Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V5Y%%////";
		f_StringLine[24] = "Var%%float&&V5Y%%0.0&%////";
		f_StringLine[25] = "Var%%float&&V5Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V4Y%%////";
		f_StringLine[26] = "Var%%float&&V4Y%%0.0&%////";
		f_StringLine[27] = "Var%%float&&V4Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V3Y%%////";
		f_StringLine[28] = "Var%%float&&V3Y%%0.0&%////";
		f_StringLine[29] = "Var%%float&&V3Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V2Y%%////";
		f_StringLine[30] = "Var%%float&&V2Y%%0.0&%////";
		f_StringLine[31] = "Var%%float&&V2Y%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V1Y%%////";
		f_StringLine[32] = "Var%%float&&V1Y%%0.0&%////";
		f_StringLine[33] = "Var%%float&&V1Y%%0.0&%Opr%%Plus**OPRVX87%%Sys%%float&&PosY%%////";
		f_StringLine[34] = "Var%%float&&V8Z%%0.0&%////";
		f_StringLine[35] = "Var%%float&&V8Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V7Z%%////";
		f_StringLine[36] = "Var%%float&&V7Z%%0.0&%////";
		f_StringLine[37] = "Var%%float&&V7Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V6Z%%////";
		f_StringLine[38] = "Var%%float&&V6Z%%0.0&%////";
		f_StringLine[39] = "Var%%float&&V6Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V5Z%%////";
		f_StringLine[40] = "Var%%float&&V5Z%%0.0&%////";
		f_StringLine[41] = "Var%%float&&V5Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V4Z%%////";
		f_StringLine[42] = "Var%%float&&V4Z%%0.0&%////";
		f_StringLine[43] = "Var%%float&&V4Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V3Z%%////";
		f_StringLine[44] = "Var%%float&&V3Z%%0.0&%////";
		f_StringLine[45] = "Var%%float&&V3Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V2Z%%////";
		f_StringLine[46] = "Var%%float&&V2Z%%0.0&%////";
		f_StringLine[47] = "Var%%float&&V2Z%%0.0&%Opr%%Plus**OPRVX87%%Var%%float&&V1Z%%////";
		f_StringLine[48] = "Var%%float&&V1Z%%0.0&%////";
		f_StringLine[49] = "Var%%float&&V1Z%%0.0&%Opr%%Plus**OPRVX87%%Sys%%float&&PosZ%%////";
		f_StringLine[50] = "Var%%float&&CountCube%%0.0&%Cond%%==^^XC%%Var%%float&&TXCUBECheck%%9.0&%////";
		f_StringLine[51] = "Function%%IFSCC&*Success%%////";
		f_StringLine[52] = "Var%%float&&V2X%%0.0&%////";
		f_StringLine[53] = "Var%%float&&V2Y%%0.0&%////";
		f_StringLine[54] = "Var%%float&&V2Z%%0.0&%////";
		f_StringLine[55] = "Var%%float&&V3X%%0.0&%////";
		f_StringLine[56] = "Var%%float&&V3Y%%0.0&%////";
		f_StringLine[57] = "Var%%float&&V3Z%%0.0&%////";
		f_StringLine[58] = "Var%%float&&V4X%%0.0&%////";
		f_StringLine[59] = "Var%%float&&V4Y%%0.0&%////";
		f_StringLine[60] = "Var%%float&&V4Z%%0.0&%////";
		f_StringLine[61] = "Var%%float&&V5X%%0.0&%////";
		f_StringLine[62] = "Var%%float&&V5Y%%0.0&%////";
		f_StringLine[63] = "Var%%float&&V5Z%%0.0&%////";
		f_StringLine[64] = "Var%%float&&V6X%%0.0&%////";
		f_StringLine[65] = "Var%%float&&V6Y%%0.0&%////";
		f_StringLine[66] = "Var%%float&&V6Z%%0.0&%////";
		f_StringLine[67] = "Var%%float&&V7X%%0.0&%////";
		f_StringLine[68] = "Var%%float&&V7Y%%0.0&%////";
		f_StringLine[69] = "Var%%float&&V7Z%%0.0&%////";
		f_StringLine[70] = "Var%%float&&V8X%%0.0&%////";
		f_StringLine[71] = "Var%%float&&V8Y%%0.0&%////";
		f_StringLine[72] = "Var%%float&&V8Z%%0.0&%////";
#endif
...
#if 0
		std::string f_RaspCompile;
		f_RaspCompile.clear();

		for(int f_Cor = 0; f_Cor < 50; f_Cor++)
			{
			f_RaspCompile += f_Rasp[f_Cor];
			}

		std::string f_RaspCompileSP;
		f_RaspCompileSP.clear();

		for(int f_Cor = 0; f_Cor < 50; f_Cor++)
			{
			f_RaspCompileSP += f_Rasp[f_Cor] + "\n";
			}
#endif
		...
		g_Schedular[1]->addContractESL(f_String);
#endif

		std::string f_nonce[2];

		//nonce
		f_nonce[0] = "Var%%float&&Rez%%1.0&%////";
		f_nonce[1] = "Var%%float&&nonce%%0.0&%Opr%%Plus**Loadn%%Var%%float&&Rez%%0.0&%//####";

		std::string f_nonceCompile;
		f_nonceCompile.clear();

		for(int f_Cor = 0; f_Cor < 2; f_Cor++)
			{
			f_nonceCompile += f_nonce[f_Cor];
			}

		std::string f_nonceCompileSP;
		f_nonceCompileSP.clear();

		for(int f_Cor = 0; f_Cor < 2; f_Cor++)
			{
			f_nonceCompileSP += f_nonce[f_Cor] + "\n";
			}

		std::string f_StringLinesn = f_nonceCompile;
		std::string f_StringLinesnText = f_nonceCompileSP;

#if 0
		OnFillTargets();
#endif

		std::thread f_Thread(&SecondaryAppWindowPageDX::Frame_OnCount, this);
	...
	void SecondaryAppWindowPageDX::OnHover(IInspectable sender, Windows::UI::Xaml::RoutedEventArgs e)
	{
	...
	void SecondaryAppWindowPageDX::Frame_OnCount(void)
	{
				...
				if(f_Double >= 10) //25 10
					...
					if(g_Schedular[1]->m_Entries[g_Schedular[1]->ac_GetEntry(g_Schedular[1]->m_Entries.size() - 1)]->at(0)[0].at(0) != '0')
						...
						for(int f_Jet = 0; f_Jet < g_Schedular[1]->m_Entries[g_Schedular[1]->ac_GetEntry(g_Schedular[1]->m_Entries.size() - 1)]->size(); f_Jet++)
							...
							f_Ack->m_PathOwner = atof(g_Schedular[1]->m_Entries[g_Schedular[1]->ac_GetEntry(g_Schedular[1]->m_Entries.size() - 1)]->at(f_Jet)[11].c_str());
	...
	void SecondaryAppWindowPageDX::acProcessAck(std::shared_ptr<Ackent> f_Ack)
	{
		switch(f_Ack->m_Type)
			{
